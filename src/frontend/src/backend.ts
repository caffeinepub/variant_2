...
export class Backend implements backendInterface {
    ...
    async deleteCard(arg0: string): Promise<boolean> {
    ...
    async getSavedCards(): Promise<Array<SavedCard>> {
        if (this.processError) {
            try {
    ...
    async saveCard(arg0: CardInput): Promise<string> {
        if (this.processError) {
            try {
    ...
    async solveQuestion(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<SolverResult> {
        if (this.processError) {
            try {
